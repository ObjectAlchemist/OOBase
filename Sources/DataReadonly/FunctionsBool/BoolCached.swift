...
public extension BoolCached {
    ...
    public convenience init(cache decorated: OOBool, in store: OOWritableKeyValue, at key: String) {
        self.init(cache: decorated, in: store, at: StringConst(key))
    }
    
    public convenience init(cache decorated: OOBool, in store: OOWritableKeyValue, at key: OOString) {
