//
//  WritableIntFromWritableKeyValueSpec.swift
//  OOSwift
//
...
final class WritableIntFromWritableKeyValueSpec: XCTestCase {

    func testGIVEN_ASourceWithoutAValue_WHEN_CheckHasValue_THEN_FalseIsReturned() {
        // GIVEN
        let source = OOWritableKeyValueFake()
        let object = WritableIntFromWritableKeyValue(source, at: OOStringFake("key"))
        // WHEN
    ...
    func testGIVEN_ASourceWithAValue_WHEN_CheckHasValue_THEN_TrueIsReturned() {
        // GIVEN
        let source = OOWritableKeyValueFake(["key":Int(1)])
        let object = WritableIntFromWritableKeyValue(source, at: OOStringFake("key"))
        // WHEN
        let result = object.hasValue
        // THEN
    ...
    func testGIVEN_ASourceWithoutAValue_WHEN_SetValue_THEN_ValueHasBeenSet() {
        ...
        object.value = Int(1)
        // THEN
        XCTAssertEqual(source.value(for: "key") as! Int, Int(1))
    }
